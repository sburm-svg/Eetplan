...
const SwipeCard = forwardRef(function SwipeCard(
  ...
  // merge the internal wrapRef with any ref forwarded from the parent
...
/* ─────────────────────────────────────────────
   RECIPE DETAIL — full-screen modal, Apple-Maps style slide-up sheet.
───────────────────────────────────────────── */
...
export default function App() {
  ...
  const isActiveFavorite = activeRecipe ? favorites.some(r => r.id === activeRecipe.id) : false;
